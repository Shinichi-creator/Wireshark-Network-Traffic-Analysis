...
This project contains screenshots and analysis from my Wireshark network traffic labs. It demonstrates packet inspection, Tcp handshakes, and DNS queries with identifying information removed for privacy
